...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    Button btnentrada, btnsalidah, btnceldas, btnpagos, btnusuarios;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnsalidah = (Button) findViewById(R.id.btnSalidaVehiculos);
        ...
        btnsalidah.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            case R.id.btnentrada:
                ...
                break;
            case R.id.btnSalidaVehiculos:
                miIntent=new Intent(MainActivity.this,SalidaVehiculosActivity.class);
                break;
            case R.id.btnceldas:
